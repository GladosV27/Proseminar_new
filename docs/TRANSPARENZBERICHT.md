...
| Umschaltbares Retrieval und Antwortdauer | Der Produktchat nutzte immer Graph-RAG; beim CPU-Modell wurden bis zu 14 Knoten, sechs längere Verlaufsnachrichten und 180 Ausgabetokens auf nur einem WASM-Thread langsam verarbeitet. | ChatGPT ergänzte Automatik, Vektor-, Graph- und Hybrid-RAG samt sichtbarer Kontext-/Zeitangabe. Für CPU-Chatantworten begrenzte es den Teilgraphen auf acht Knoten, die Historie auf vier kompakte Nachrichten und die Ausgabe auf 112 Tokens. | Ich behandle diese Einstellungen ausdrücklich als UX-Optimierung des Chats. Experimentläufe übergeben keine Chat-Limits und behalten ihre eingefrorenen Retrieval- und Generierungsdefaults; dadurch werden alte und neue Messläufe nicht vermischt. |
