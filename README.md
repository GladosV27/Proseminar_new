...
- **Noesis · philosophischer Wissensdialog (Standardansicht)** – natürlicher Multi-Turn-Chat über Philosophie- und Ideengeschichte. Noesis löst Anschlussbezüge auf, verbindet passende Graphknoten und legt Quellen auf Wunsch offen. Ein eigener Schalter erlaubt automatische Wikipedia-Recherche ausschließlich bei lokalen Wissenslücken; alternativ wählt der Nutzer Artikel manuell. Natürlichsprachliche Befehle wie „Füge Albert Einstein in deinen Wissensbaum hinzu“ starten den Import direkt im Chat; mehrdeutige Treffer werden zur Auswahl angeboten. Übernommen werden nur Auszüge und tatsächlich von MediaWiki gelieferte Links, die anschließend lokal verfügbar bleiben.
- **Live-Gespräch** – ein eigener, mobil optimierter Sprachdialog hört einen Sprachzug, sendet das Transkript an dieselbe transparente Graph-RAG-Pipeline, liest die fertige Antwort vor und öffnet danach automatisch wieder das Mikrofon. Die Ausgabe wählt hochwertige deutsche Browser-/Systemstimmen bevorzugt aus, lässt Stimme und Tempo manuell einstellen und glättet Markdown, Satzgrenzen, Prosodie und Pausen für eine natürlichere Wiedergabe. Pausieren, Stummschalten, Unterbrechen und Beenden sind jederzeit möglich. Die App selbst speichert keine Audiodatei; Erkennung und Stimme stammen jedoch aus Browser beziehungsweise Betriebssystem und können je nach Gerät Online-Dienste des Anbieters nutzen. Deshalb bleibt das Mikrofon im Noesis-Offline-Modus gesperrt und startet online erst nach einer zweiten, informierten Bestätigung im Dialog.
